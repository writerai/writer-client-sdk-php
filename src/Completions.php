...
class Completions 
{
    ...
    ): \WriterAi\SDK\Models\Operations\CreateCompletionResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/llm/organization/{organizationId}/model/{modelId}/completions', \WriterAi\SDK\Models\Operations\CreateCompletionRequest::class, $request, $this->_globals);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/llm/organization/{organizationId}/model/{modelId}/customization/{customizationId}/completions', \WriterAi\SDK\Models\Operations\CreateModelCustomizationCompletionRequest::class, $request, $this->_globals);
